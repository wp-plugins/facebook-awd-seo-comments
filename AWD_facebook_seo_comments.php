...
//		AHWEBDEV License ©2011 All right resrved
//
//		This program is not free, you can't share it, modify or sell it.
//      To use it, you must obtain permissions from AHWEBDEV.FR
//		contact@ahwebdev.fr
...
Class AWD_facebook_seo_comments{
    ...
    */
    public $version_requiered = '0.9.7.7';
	/**
	* Name of the file (class)
	*/
	public $file_name = 'AWD_facebook_seo_comments.php';
	...
	public function initial(){
	    ...
	    require_once(dirname(__FILE__).'/inc/classes/class.facebook_comments.php');
		require_once(dirname(__FILE__).'/inc/classes/class.table_comments.php');
	...
	*/
	public function deactivation_sheduled_event(){
	...
	*/
	public function self_init(){
		...
		register_deactivation_hook(__FILE__, array(&$this,'deactivation_sheduled_event'));
	    ...
	    if($this->AWD_facebook->plugin_option['comments_merge'] == 1)
	    	add_filter('comments_array', array(&$this,'set_comments_content'),10,2);
	    if($this->AWD_facebook->plugin_option['comments_fb_display'] == 1)
	    ...
	    $plugin_infos = get_plugins('/'.plugin_basename( dirname(__FILE__ )));
	    $this->infos = $plugin_infos[$this->file_name];
	    $this->AWD_facebook_comments = new AWD_facebook_comments($this->AWD_facebook);
	}
	/**
	* Footer admin
	*/ 
	public function admin_footer_text($footer_text){
	    return $footer_text."  ".__('| With:',$this->plugin_text_domain)." <a href='http://www.ahwebdev.fr/plugins/facebook-awd.html'>".$this->plugin_name." v".$this->infos['Version']."</a>";
	}
	
	/**
	* Init hook call with add_action init.
	*/
	public function init_hook(){
		//Test clear cahce all time... no good.
	...
	*/
	public function admin_init(){
		...
		//know we got OPTION
	    //check if fb connect api is enable
	    if(!is_object($this->AWD_facebook->fcbk)){
			add_action('admin_notices',array(&$this,'no_fbconnect_api'));
			deactivate_plugins(__FILE__);
		}
	}
	...
	*/
	public function set_comments_number($count, $post_id){
		$this->AWD_facebook_comments->set_AWD_facebook();
		if($this->AWD_facebook->plugin_option['comments_count_merge'] == 1){
						...
						<tr class="dataRow" >
							...
							<td class="data">
								<select id="<?php echo $this->AWD_facebook->plugin_option_pref; ?>comments_merge" name="<?php echo $this->AWD_facebook->plugin_option_pref; ?>comments_merge" class="uiSelectHTML" onchange="onchange_uiSelect(this.id);">
									<option value="0" <?php if($this->AWD_facebook->plugin_option['comments_merge'] == 0) echo 'selected="selected"'; ?> ><?php _e('No',$this->plugin_text_domain); ?></option>
									<option value="1" <?php if($this->AWD_facebook->plugin_option['comments_merge'] == 1) echo 'selected="selected"'; ?>><?php _e('Yes',$this->plugin_text_domain); ?></option>
								</select>
							</td>
						</tr>
						<tr class="dataRow">
							...
							<td class="data">
								<select id="<?php echo $this->AWD_facebook->plugin_option_pref; ?>comments_cache" name="<?php echo $this->AWD_facebook->plugin_option_pref; ?>comments_cache" class="uiSelectHTML" onchange="onchange_uiSelect(this.id);">
									<option value="0" <?php if($this->AWD_facebook->plugin_option['comments_cache'] == "0") echo 'selected="selected"'; ?> ><?php _e('Disable',$this->plugin_text_domain); ?></option>
									<option value="hourly" <?php if($this->AWD_facebook->plugin_option['comments_cache'] == "hourly") echo 'selected="selected"'; ?>><?php _e('Hourly',$this->plugin_text_domain); ?></option>
									<option value="twicedaily" <?php if($this->AWD_facebook->plugin_option['comments_cache'] == "twicedaily") echo 'selected="selected"'; ?>><?php _e('Twice daily',$this->plugin_text_domain); ?></option>
									<option value="daily" <?php if($this->AWD_facebook->plugin_option['comments_cache'] == "daily") echo 'selected="checked"'; ?>><?php _e('Daily',$this->plugin_text_domain); ?></option>
								</select><br />
								<?php
								if($this->AWD_facebook->plugin_option['comments_cache'] != "0"){
						...
						<tr class="dataRow">
							...
							<td class="data">
								<select id="<?php echo $this->AWD_facebook->plugin_option_pref; ?>comments_fb_display" name="<?php echo $this->AWD_facebook->plugin_option_pref; ?>comments_fb_display" class="uiSelectHTML" onchange="onchange_uiSelect(this.id);">
									<option value="0" <?php if($this->AWD_facebook->plugin_option['comments_fb_display'] == 0) echo 'selected="selected"'; ?> ><?php _e('No',$this->plugin_text_domain); ?></option>
									<option value="1" <?php if($this->AWD_facebook->plugin_option['comments_fb_display'] == 1) echo 'selected="selected"'; ?>><?php _e('Yes',$this->plugin_text_domain); ?></option>
								</select>
							</td>
						</tr>
						<tr class="dataRow">
							...
							<td class="data">
								<select id="<?php echo $this->AWD_facebook->plugin_option_pref; ?>comments_count_merge" name="<?php echo $this->AWD_facebook->plugin_option_pref; ?>comments_count_merge" class="uiSelectHTML" onchange="onchange_uiSelect(this.id);">
									<option value="0" <?php if($this->AWD_facebook->plugin_option['comments_count_merge'] == 0) echo 'selected="selected"'; ?>><?php _e('No',$this->plugin_text_domain); ?></option>
									<option value="1" <?php if($this->AWD_facebook->plugin_option['comments_count_merge'] == 1) echo 'selected="selected"'; ?>><?php _e('Yes',$this->plugin_text_domain); ?></option>
								</select>
							</td>
						</tr>
					</table>
...
//instance
$AWD_facebook_seo_comments = new AWD_facebook_seo_comments();
?>